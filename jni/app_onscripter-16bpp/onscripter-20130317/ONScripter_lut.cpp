...
static ONScripter::FuncLUT func_lut[] = {
	...
	{"vibrator",		&ONScripter::vibratorCommand},
	...
	{"loopbgm2",		&ONScripter::loopbgm2Command},
	...
	{"inputbox",		&ONScripter::inputboxCommand},
	...
	{"getinputext",		&ONScripter::getinputextCommand},
    ...
    {"getspnum",		&ONScripter::getspnumCommand},
    {"getsp2num",		&ONScripter::getspnumCommand},
    ...
    {"cleannum",				&ONScripter::cleannumCommand},
    {"cleanstr",				&ONScripter::cleanstrCommand},
    {"chvol",			&ONScripter::chvolCommand},
    {"checkpage",		&ONScripter::checkpageCommand},
    {"checksp",		&ONScripter::checkspCommand},
    {"checksp2",		&ONScripter::checkspCommand},
    ...
    {"switch",	&ONScripter::switchCommand},
    {"case",	&ONScripter::caseCommand},
    {"default",	&ONScripter::defaultCommand},
    {"sprintf",	&ONScripter::sprintfCommand},
    {"defv",	&ONScripter::defvCommand},
    {"defbgm",	&ONScripter::defbgmCommand},
	{"localon", &ONScripter::localonCommand},
    {"", NULL}
};
