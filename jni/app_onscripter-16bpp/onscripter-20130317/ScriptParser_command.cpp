...
int ScriptParser::rubyonCommand()
{
    ...
    if ( script_h.getchar3(buf) == 0x0a || script_h.getchar3(buf) == ':' || script_h.getchar3(buf) == ';' ){
...
{
    if (condition_flag) return RET_SKIP_LINE;
    else {
    ...
    while(1){
        if (script_h.compareString("fchk")){
            ...
            if (script_h.current_variable.type & ScriptHandler::VAR_INT ||
                ...
                if ( (script_h.getchar3(op_buf) == '>' && script_h.getchar3(op_buf+1) == '=') ||
                     (script_h.getchar3(op_buf) == '<' && script_h.getchar3(op_buf+1) == '=') ||
                     (script_h.getchar3(op_buf) == '=' && script_h.getchar3(op_buf+1) == '=') ||
                     (script_h.getchar3(op_buf) == '!' && script_h.getchar3(op_buf+1) == '=') ||
                     (script_h.getchar3(op_buf) == '<' && script_h.getchar3(op_buf+1) == '>') )
                    script_h.setCurrent(op_buf+2);
                else if ( script_h.getchar3(op_buf) == '<' ||
                          script_h.getchar3(op_buf) == '>' ||
                          script_h.getchar3(op_buf) == '=' )
                ...
                if      (script_h.getchar3(op_buf) == '>' && script_h.getchar3(op_buf+1) == '=') f = (left_value >= right_value);
                else if (script_h.getchar3(op_buf) == '<' && script_h.getchar3(op_buf+1) == '=') f = (left_value <= right_value);
                else if (script_h.getchar3(op_buf) == '=' && script_h.getchar3(op_buf+1) == '=') f = (left_value == right_value);
                else if (script_h.getchar3(op_buf) == '!' && script_h.getchar3(op_buf+1) == '=') f = (left_value != right_value);
                else if (script_h.getchar3(op_buf) == '<' && script_h.getchar3(op_buf+1) == '>') f = (left_value != right_value);
                else if (script_h.getchar3(op_buf) == '<')                     f = (left_value <  right_value);
                else if (script_h.getchar3(op_buf) == '>')                     f = (left_value >  right_value);
                else if (script_h.getchar3(op_buf) == '=')                     f = (left_value == right_value);
            }
            else{
                ...
                if      (script_h.getchar3(op_buf) == '>' && script_h.getchar3(op_buf+1) == '=') f = (val >= 0);
                else if (script_h.getchar3(op_buf) == '<' && script_h.getchar3(op_buf+1) == '=') f = (val <= 0);
                else if (script_h.getchar3(op_buf) == '=' && script_h.getchar3(op_buf+1) == '=') f = (val == 0);
                else if (script_h.getchar3(op_buf) == '!' && script_h.getchar3(op_buf+1) == '=') f = (val != 0);
                else if (script_h.getchar3(op_buf) == '<' && script_h.getchar3(op_buf+1) == '>') f = (val != 0);
                else if (script_h.getchar3(op_buf) == '<')                     f = (val <  0);
                else if (script_h.getchar3(op_buf) == '>')                     f = (val >  0);
                else if (script_h.getchar3(op_buf) == '=')                     f = (val == 0);
            }
        }
...
int ScriptParser::getparamCommand()
{
    ...
    do{
        ...
        if ( script_h.pushed_variable.type & ScriptHandler::VAR_PTR ){
			...
			last_nest_info=last_nest_info->previous;
			int tmp=script_h.readInt();
			last_nest_info=last_nest_info->next;
            script_h.setInt( &script_h.pushed_variable, tmp );
        }
...
int ScriptParser::switchCommand()
{
    script_h.readVariable();
    script_h.pushBufVariable();
    switch_flag = true;
	return RET_CONTINUE;
}
...
int ScriptParser::defaultCommand()
{
    if (!switch_flag) {
        //delete &script_h.switch_buf;
        return RET_SKIP_LINE;
...
//added by Taigacon
int ScriptParser::localonCommand()
{
    if ( current_mode != DEFINE_MODE )
        errorAndExit( "localon: not in the define section" );
    script_h.localon_flag = true;
    return RET_CONTINUE;
} 
