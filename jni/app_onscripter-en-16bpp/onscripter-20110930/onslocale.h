...
/*
#define MESSAGE_SAVE_EXIST LOCSTR_DEFAULT_SAVE_MENU_NAME
#define MESSAGE_SAVE_EMPTY LOCSTR_MESSAGE_SAVE_EMPTY_1B
#define MESSAGE_SAVE_CONFIRM LOCSTR_MESSAGE_SAVE_CONFIRM_1B
#define MESSAGE_LOAD_CONFIRM LOCSTR_MESSAGE_LOAD_CONFIRM_1B
#define MESSAGE_RESET_CONFIRM LOCSTR_MESSAGE_RESET_CONFIRM_1B
#define MESSAGE_END_CONFIRM LOCSTR_MESSAGE_END_CONFIRM_1B
#define MESSAGE_YES LOCSTR_MESSAGE_YES_1B
#define MESSAGE_NO LOCSTR_MESSAGE_NO_1B
*/
