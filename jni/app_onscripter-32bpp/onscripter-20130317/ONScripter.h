...
#define DEFAULT_WM_TITLE "ONScripter Ver.20130511[CN Safity Crypt Version,Modify by natdon,Taigacon,gjy,Swec]"
...
public:
    ...
    int waitCommand();
	int vibratorCommand();//Added by Natdon
    int vspCommand();
    int voicevolCommand();
    int vCommand();
    ...
    int spstrCommand();
    int spreloadCommand();
            int sprintfCommand(); // Added by Taigacon
    int splitCommand();
    int spclclkCommand();
    int spbtnCommand();
    int skipoffCommand();
    ...
    int loopbgmCommand();
	int loopbgm2Command(); //Added by Natdon
    ...
    int isdownCommand();
    int inputCommand();
	int inputboxCommand(); //Added by Natdon
    int indentCommand();
    int humanorderCommand();
	int getinputextCommand(); //Added by Natdon
    int getzxcCommand();
    ...
    int getspmodeCommand();
        int getspnumCommand(); //Added by Taigacon
    int getsevolCommand();
    ...
    int fileexistCommand();
            int ext_vCommand(); //Added by Taigacon
            int ext_bgmCommand();//Added by Taigacon
    int exec_dllCommand();
    int exbtnCommand();
    int erasetextwindowCommand();
    int endCommand();
          int defvCommand();//Added by Taigacon
          int defbgmCommand();//Added by Taigacon
    ...
    int defineresetCommand();
        int cspCommand();//Modified by Taigacon
    int cselgotoCommand();
    int cselbtnCommand();
    int clickCommand();
    int clCommand();
        int cleannumCommand(); //Added by Taigacon
        int cleanstrCommand(); //Added by Taigacon
    int chvolCommand();
    int checkpageCommand();
        int checkspCommand(); //Added by Taigacon
	int checkkeyCommand();
    int cellCommand();
    int captionCommand();
    int btnwait2Command();
...
private:
    ...
    int  event_mode;
    int defpath(char **buf,const char *set_value);
    int defext(char **buf,const char *set_value,const char *default_value);
    bool is_script_read;
...
private:
    ...
    // Taigacon : defined in defv and defbgm , used in ext_v and bgm_v .
    char *defv_path;
    char *defv_ext;
    char *defbgm_path;
    char *defbgm_ext;
	...
	void errorAndExit( const char *str, const char *reason = NULL );	//added by Taigacon, to save screenshot before exit
};
