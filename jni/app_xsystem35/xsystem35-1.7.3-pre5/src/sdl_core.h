...
extern void sdl_updateAreaWithoutRefresh(MyRectangle *src, MyPoint *dst);
...
#define UpdateAreaWithoutRefresh(src,dst) sdl_updateAreaWithoutRefresh((src),(dst))
#define Refresh() sdl_refresh()
